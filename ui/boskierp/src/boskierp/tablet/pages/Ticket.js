              ...
              <div className="w-full h-full grid grid-cols-1 gap-8 px-8 py-8">
                <form onSubmit={submit} className="w-full h-full flex flex-col gap-8">
                  ...
                  <div className="w-full grid grid-cols-2 gap-4">
                    ...
                    <input type="text" defaultValue={state?.money} id="money" className="p-4 pl w-full text-sm rounded-lg border  bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-gray-500 focus:border-blue-500" placeholder="Ilość grzywny" />
                  </div>
                  ...
                  <div className="
                                        ...
                                        ">
                    <button type="submit" className="text-white mx-2  focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-4 py-2 bg-gray-600 hover:bg-gray-400 focus:ring-gray-800 w-fit h-fit">Wystaw mandat</button>
