...
export default class Main extends React.Component {
  ...
  render() {
    return (
      <div className="bg-yellow-800 w-full h-full text-white">
        <div className="flex h-full">
          <div className="w-1/4 ">
            <div className="w-full h-full flex justify-start flex-col items-center p-2 shadow-md bg-yellow-800 border-gray-700">
                ...
                <div className="p-2 w-full">
                  ...
                  <div className="flex justify-center">
                    {this.state.elements.sideButtons.map((v) => {
                      return <button type="button" className="w-full m-2  border focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center border-yellow-600 text-gray-400 hover:text-white hover:bg-gray-600 focus:ring-gray-800">{v.label}</button>
                    })}
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col h-full w-full">
            <div className="w-full h-1/2">
              <div className="w-full h-full overflow-auto">
                <div className="p-2 bg-yellow-700 rounded text-left">
                  <h2>Ostatnie zgłoszenia</h2>
                </div>
                <table className="table-fixed w-full">
                  <thead className="sticky top-0 bg-yellow-800">
                    <tr>
                  ...
                  <tbody className="break-words">
                    {this.state.reports.map((v, i) => {
                      return <tr className="border-b hover:bg-yellow-700 ">
