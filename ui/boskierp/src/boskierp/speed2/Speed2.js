...
export default class Speed2 extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            show: false,
    ...
    render() {
        ...
        return <div className="w-full h-full absolute text-white">
            <div className={this.classes[this.state.main]}>
                <div style={{scale: this.state.scale+"%"}} className="w-1/6 h-1/4 bg-black rounded-lg bg-opacity-90 flex gap-2 justify-end">
                    <div className=" flex flex-col justify-between p-2 w-full items-center">
                        <div className="  flex items-center gap-4 font-semibold">
                            <div className="text-lg text-center">
                                {this.state.road.name}
                            </div>
                        </div>
                        <div className="text-5xl text-center flex" style={{fontFamily: "digital2"}}>
                            {this.state.speed}
                            <div className="text-xl flex flex-col self-end">
                                <div>
                                    km/h
                                </div>
                            </div>
                        ...
                        <div className="font-semibold text-center">
                            {this.state.road.second}
                        </div>
                        <div className="self-end justify-self-end" style={{fontFamily: "digital2"}}>
                            GEAR: {this.state.gear}
                        </div>
                        </div>
                        <div style={{width: `${this.state.speed/5}%`}} className="h-2 bg-green-500 rounded-lg self-start">

                        </div>
                    </div>
                    <div className="p-1 flex flex-col gap-2 items-center w-9">
                        <div>
                        ...
                        <div className="">
                            <svg className="w-5 h-5  " viewBox="0 0 30 30" id="Layer_1" version="1.1" xmlns="http://www.w3.org/2000/svg" >
                            <defs>
...
{!this.state.doorLock ? <svg className="w-10 h-5 text-green-500" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
<svg fill="currentColor" style={{ color: !this.state.engine ? "red" : "green" }} className=" w-10 h-5" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.999 511.999" >
                        <g>
                            <g>
                        ...
                        <div>
                    {this.state.lights === "short" && <svg fill="currentcolor" className="w-10 h-5 text-yellow-500" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" >
                        <g>
                            <g>
                                <g>
                        ...
                        <div>
                        {this.state.lights === "long" && <svg className="w-10 rotate-180 h-5 text-blue-500" fill="currentColor" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 504.657 504.657">
                        <g>
                            <g>
                                <g>
                        ...
                        <div>
                                {this.state.signal.left && <svg className="w-10 animate-pulse   h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 2.5V6h7v8h-7v3.5L2.5 10 10 2.5z" /></svg>}
                        </div>
                        <div>
                            {this.state.signal.right && <svg className="w-10 h-5 text-green-500  animate-pulse " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.5 10L10 17.5V14H3V6h7V2.5l7.5 7.5z" /></svg>}
                        </div>
                    </div> 
                    <div style={{height: `${this.state.rpm/100}%`}} className="w-2 bg-green-500 rounded-lg">
