...
export default function Gallery(props) {
  ...
  return (
    <div className="w-full h-full text-white bg-black bg-opacity-70  px-2 relative 
        ">
        ...
        <div className="w-full h-full grid grid-cols-2 gap-4 content-start justify-items-center overflow-y-scroll">
          {photos.map((v, i) => {
            return <div className="w-full h-full flex flex-col gap-2 text-lg font-bold break-all">
              <div>
                <img onClick={(e) => showImage(e)} className="overflow-auto origin-center object-cover w-full h-full" src={v.img} alt={"zd"} ></img>
              </div>
