...
export default function Footer(props) {
    ...
    const [notifies, setNotifies] = useState(props.notifies || {
        // notifies:10,
        // messages:4,
        // calls:4
    })
    ...
    return (
        <div className=" select-none w-full h-18 ">
            <section className="text-gray-400 bg-gray-700 bg-opacity-30 py-3 -mb-3  rounded-b-3xl">
