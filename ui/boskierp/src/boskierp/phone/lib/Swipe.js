/* https://codepen.io/CapnMarius/pen/ZeGEEG */
...
export default class Swipe {
    ...
    removeListeners() {
	  this.elem.removeEventListener("touchstart", e => this.down(e));
	  this.elem.removeEventListener("mousedown", e => this.down(e));
	  this.elem.removeEventListener("touchmove", e => this.move(e));
	  document.removeEventListener("mousemove", e => this.move(e));
	  this.elem.removeEventListener("touchend", e => this.up(e));
