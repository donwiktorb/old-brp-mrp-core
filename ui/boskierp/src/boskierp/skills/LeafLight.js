...
export default class LeafLight extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    render() {
        return <div className="w-full h-full flex justify-center items-center relative z-20 flex-col">
            <div className="h-1/2 w-full flex justify-center items-center" >
                <img onMouseDown={(e) => this.clicked(e)} id="hello" src="https://boskierp.pl/img/ss/dwb_lAlh.png" className="w-40  -rotate-[] absolute top-0 left-0" alt="LOGO" />
            </div> 
